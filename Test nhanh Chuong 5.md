...
Javascript là ,ột ngôn ngữ lập trình kịch bản dựa vào các đối tượng có sẵn hoặc do lâp trình viên tự định nghĩa

2) JavaScript có thể chạy ở đâu? Nêu ít nhất 2 môi trường. [web:37]  
Javascript có thể chạy được ở trên trình duyệt và server
...
5) JavaScript dùng để xử lý tương tác và hành vi của trang web. _Đ_ [web:37]
...
Dòng 1 với 2 chạy được.
Dòng 3 không chạy được. vì const không cho phép gán lại biến
...
....................................................................................
== : trả về giá trị true hoặc false , không nghiêm ngặt
=== : trả về true hoặc false với 2 phần tử được so sánh cùng kiểu dữ liệu với nhau, nghiêm ngặt hơn
---
...
khi 1 điều kiện đùng các nhánh còn lại không được kiểm tra nữa
...
Argument (đối số): là giá trị thực được truyền vào khi gọi hàm.
sum(a,b) a với b là tham số
sum(2,3) 2 với 3 là đối số
...
Constructor là hàm được gọi tự động khi tạo object mới từ class, dùng để khởi tạo giá trị ban đầu cho object.
...
Prototype là cơ chế cho phép object kế thừa thuộc tính và method từ object khác trong JavaScript.
Khi truy cập một thuộc tính không có trong object, JavaScript sẽ tìm trong prototype của nó.
Nếu chưa thấy, nó sẽ tiếp tục tìm lên chuỗi prototype (prototype chain).
